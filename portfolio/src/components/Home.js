...
const Home = () => {
    ...
    return(
        ...
        >
            <motion.div
            className="bg-gray-900 flex flex-col h-screen"
            ...
            >
                ...
                <motion.div className="flex flex-nowrap h-32 justify-start lg:ml-32 sm:ml-12">
                    ...
                    >
                        <motion.span style={{display:"inline-block"}} variants={letter}>T</motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>o</motion.span>
                        <motion.span > </motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>m</motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>y</motion.span>
                        <motion.span > </motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>W</motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>e</motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>b</motion.span>
                        <motion.span style={{display:"inline-block"}} variants={letter}>s</motion.span>
