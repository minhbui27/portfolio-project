    ...
    return(
        <group ref={welcomeText}>
            <mesh position={[positionX,positionY,positionZ]}>
                <Text outlineWidth="5%" outlineColor="black" color="white" anchorX="left" anchorY="middle" fontSize="1" 
            ...
            <mesh position={[positionX,positionY-2.4,positionZ]}>
                <Text outlineWidth="5%" color="#DEB841" anchorX="left" anchorY="middle" fontSize="1" 
                ...
                <Suspense fallback={null}>
                    <ScrollControls pages={2}>
                        <Bounds fit clip observe margin={10} fixedOrientation>
                            <Html position={[-1,4,0]}>
                                <div className='text-white md:opacity-0 opacity-100 align-center'>Use desktop for the best experience</div>
                            </Html>
                            {/* <Car position={[0,0,0]}/> */}
